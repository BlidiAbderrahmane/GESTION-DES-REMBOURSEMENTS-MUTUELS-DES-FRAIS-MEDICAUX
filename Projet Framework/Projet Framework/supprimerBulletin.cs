...
{
    public partial class supprimerBulletin : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    deconnecter();
                    cnx.Open();
                    cmd = new SqlCommand("delete from bulletinsoin where numbulletin='" + textBox1.Text + "'", cnx);
                    cmd.ExecuteNonQuery();
                    MessageBox.Show("Bulletin de Soin est supprimé", "SUPPRESSION", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    table.Clear();
                    remplirdgv();
                    textBox1.Text = "";
                    cnx.Close();
